...
#define IMU_GYRO_TRANS_RADIAN_CONSTANT (3755.0)  // ±500dps: 32768*180/(500*π) ≈ 3755

//Define CNN
//The out put of model must bigger than this value unless it will give a unrecognized message
#define OUPUT_THRESHOLD 103 

//Define IR (v1221 TX + v1222 RX) — RAW 万能学习模式
#define IR_TX_PORT            GPIOA
#define IR_TX_PIN             GPIO_Pin_15
#define IR_RX_PORT            GPIOB
#define IR_RX_PIN             GPIO_Pin_0
#define IR_FLASH_ADDR         ((uint32_t)0x0801E800)  // F103CBT6 pages 122-127, 6KB
#define IR_GESTURE_COUNT      (13)

//Define LED bit lines for learn mode slot display
#define IR_LED_PORT           GPIOA
#define IR_LED_MASK           (GPIO_Pin_6 | GPIO_Pin_5 | GPIO_Pin_4 | GPIO_Pin_3)
